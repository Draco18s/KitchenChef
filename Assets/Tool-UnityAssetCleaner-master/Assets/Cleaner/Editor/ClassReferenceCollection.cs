...
namespace AssetClean
{
	public class ClassReferenceCollection : IReferenceCollection
	{
		...
		List<System.Type> CollectionAllClasses ()
		{
			...
			Debug.Log($"Path: {Path.GetFullPath("Library/ScriptAssemblies/Assembly-CSharp.dll")}");
			if (File.Exists ("Library/ScriptAssemblies/Assembly-CSharp.dll"))
			{
				alltypes.AddRange(Assembly.LoadFile(Path.GetFullPath("Library/ScriptAssemblies/Assembly-CSharp.dll")).GetTypes());
			}
			if (isSaveEditorCode && File.Exists ("Library/ScriptAssemblies/Assembly-CSharp-Editor.dll"))
				alltypes.AddRange (Assembly.LoadFile (Path.GetFullPath("Library/ScriptAssemblies/Assembly-CSharp-Editor.dll")).GetTypes ());
